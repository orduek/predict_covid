...
## Hazan:
* Keep 1st dose - done
* Divide 24 hours for first dose - done
* divide hours to 2/3 group - randomly assign risk/effectiveness (0.85-1)
* Cox finds the level of effectiveness?
* Start building the Bayes model
